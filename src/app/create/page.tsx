      ...
      <Card className="space-y-6">
        ...
        <div className="bg-slate-950 p-4 rounded-lg border border-slate-800 space-y-2">
          ...
          <p className="text-xs text-slate-400 leading-relaxed">
            Room creation business logic (POST /api/rooms integration and form handling) will be implemented in Phase F2.
            This route shell validates the App Router routing structure.
          </p>
        </div>
